...
const resetPassword = () => {
  ...
  const schema = Yup.object().shape({
    password: Yup.string()
      ...
      .max(15, "new_password_max_15_characters"),
    confirmPassword: Yup.string()
      .required("confirm_password_required")
      .oneOf([Yup.ref("password"), null], "confirm_password_notMatch")
      .min(8, "password_atLeast_8_characters")
      .max(15, "new_confirm_password_max_15_characters"),
  });
                ...
                <div className="w-full card  py-2 px-2">
                  <div className="py-4 px-4">
                    <form onSubmit={handleSubmit}>
                      <div className="flex justify-content-center w-100 mb-2 auth-header font-bold text-2xl mb-4">
                        {t("sent_new_password")}
                      </div>
                      <div>
